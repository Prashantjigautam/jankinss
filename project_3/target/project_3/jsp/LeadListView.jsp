...
<body class="hm">
	...
	<div>
		<form action="<%=ORSView.LEAD_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 class="text-primary font-weight-bold pt-3">Lead List</h1>
			</center>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input class="form-control" type="text" name="name" maxlength="20"
						placeholder="Enter contactName" class="p1"
				...
				<table class="table  table-info table-bordered table-hover">
					...
					<tbody>
						<tr>
							...
							<td align="center"><a href="LeadCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
