				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div>
								<%
									List l = (List) request.getAttribute("Contactlist");
								%>
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<%=HTMLUtility.getList("city", String.valueOf(dto.getCity()), l)%>
									</div>
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										style="font-size: 17px" value="<%=ContactCtl.OP_CANCEL%>">
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										style="font-size: 17px" value="<%=ContactCtl.OP_RESET%>">
								</div>
