...
<body class="hm">
	...
	<div>
		<form action="<%=ORSView.DOCTOR_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 class="text-primary font-weight-bold pt-3">Doctor List</h1>
			</center>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input class="form-control" type="text" name="expertise"
						placeholder="Enter expertise" class="p1"
				...
				<table class="table  table-info table-bordered table-hover">
					...
					<tbody>
						<tr>
							...
							<td align="center"><a href="DoctorCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
