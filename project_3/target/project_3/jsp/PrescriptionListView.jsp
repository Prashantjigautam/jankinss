...
<body class="hm">
	...
	<div>
		<form action="<%=ORSView.PRESCRIPTION_LIST_CTL%>" method="post">
			...
			<%
				List list1 = (List) request.getAttribute("Prescriptionlist");
			%>
			...
			%>
			<center>
				<h1 class="text-primary font-weight-bold pt-3">Prescription
					List</h1>
			</center>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input class="form-control" type="number" name="capacity"
						placeholder="Enter capacity" class="p1"
				...
				<table class="table  table-info table-bordered table-hover">
					...
					<tbody>
						<tr>
							...
							<td align="center"><a
								href="PrescriptionCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
