							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="number" class="form-control" name="payTerm"
											placeholder="Enter Payment Term" oninput="numberlength(this)"
											value="<%=DataUtility.getStringData(dto.getPayTerm())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("payTerm", request)%></font></br>
