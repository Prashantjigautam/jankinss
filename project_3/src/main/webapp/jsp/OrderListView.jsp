...
<body class="hm">
	...
	<div>
		<form action="<%=ORSView.ORDER_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 class="text-primary font-weight-bold pt-3">Order List</h1>
			</center>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input class="form-control" type="text" name="ammount"
						placeholder="Enter amount" class="p1"
						value="<%=ServletUtility.getParameter("ammount", request)%>">
				</div>
				<div class="col-sm-2">
				...
				<table class="table  table-info table-bordered table-hover">
					...
					<tbody>
						<tr>
							...
							<td align="center"><a href="OrderCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
