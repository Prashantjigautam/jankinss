<%@page import="in.co.rays.project_3.controller.ShoppingCardCtl"%>
...
<body class="hm">
	...
	<div>
		...
		<main>
		<form action="<%=ORSView.SHOPPINGCARD_CTL%>" method="post">
			<jsp:useBean id="dto"
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div>
								<%
									List l = (List) request.getAttribute("ShoppingCardlist");
								%>
							...
							<div class="md-form">
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										value="<%=ShoppingCardCtl.OP_UPDATE%>"> <input
										type="submit" name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=ShoppingCardCtl.OP_CANCEL%>">
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										class="btn btn-success btn-md" style="font-size: 17px"
										value="<%=ShoppingCardCtl.OP_SAVE%>"> <input
										type="submit" name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=ShoppingCardCtl.OP_RESET%>">
								</div>
