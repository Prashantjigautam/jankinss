...
<body class="hm">
	...
	<div>
		<form action="<%=ORSView.PROJECT_LIST_CTL%>" method="post">
			...
			<%
				List list1 = (List) request.getAttribute("Projectlist");
			%>
			...
			%>
			<center>
				<h1 class="text-primary font-weight-bold pt-3">Project List</h1>
			</center>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input class="form-control" type="text" name="version"
						placeholder="Enter version" class="p1"
				...
				<table class="table  table-info table-bordered table-hover">
					...
					<tbody>
						<tr>
							...
							<td align="center"><a href="ProjectCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=ProjectListCtl.OP_BACK%>">
			</div>
			<%
				}
			%>
