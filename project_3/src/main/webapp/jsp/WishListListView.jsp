...
<%@page import="in.co.rays.project_3.dto.WishListDTO"%>
<%@page import="in.co.rays.project_3.controller.WishListListCtl"%>
...
<body class="hm">
	...
	<div>
		<form action="<%=ORSView.WISHLIST_LIST_CTL%>" method="post">
			...
			<%
				List list1 = (List) request.getAttribute("WishListlist");
			%>
			...
			<%
				...
				Iterator<WishListDTO> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
				<h1 class="text-primary font-weight-bold pt-3">WishList List</h1>
			</center>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input class="form-control" type="text" name="username"
						placeholder="Enter username" class="p1"
						value="<%=ServletUtility.getParameter("username", request)%>">
				</div>

				<div class="col-sm-2">
					<input class="form-control" type="text" name="remark"
						placeholder="Enter remark" class="p1"
				...
				<div class="col-sm-2">
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=WishListListCtl.OP_SEARCH%>">&emsp; <input
						type="submit" class="btn btn-dark btn-md" style="font-size: 17px"
						name="operation" value="<%=WishListListCtl.OP_RESET%>">
				</div>
				...
				<table class="table  table-info table-bordered table-hover">
					...
					<tbody>
						<tr>
							...
							<td align="center"><a href="WishListCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			<table width="100%">
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=WishListListCtl.OP_PREVIOUS%>"
					...
					<td align="right"><input type="submit" name="operation"
						class="btn btn-secondary btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=WishListListCtl.OP_NEXT%>"
			...
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=WishListListCtl.OP_BACK%>">
			</div>
			<%
				}
			%>
