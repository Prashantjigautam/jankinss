2<%@page import="in.co.rays.project_3.controller.LoginCtl"%>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.SHOPPINGCARD_CTL%>"><i
							class="fas fa-user-circle"></i>Add ShoppingCard</a> <a
							class="dropdown-item" href="<%=ORSView.SHOPPINGCARD_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>ShoppingCard List</a>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PRODUCTDETAILS_CTL%>"><i
							class="fas fa-user-circle"></i>Add ProductDetails</a> <a
							class="dropdown-item" href="<%=ORSView.PRODUCTDETAILS_LIST_CTL%>"><i
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PATIENT_CTL%>"><i
							class="fas fa-user-circle"></i>Add Patient</a> <a
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">WishList</font>
				</a>

					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.DOCTOR_CTL%>"><i
							class="fas fa-user-circle"></i>Add WishList</a> <a
							class="dropdown-item" href="<%=ORSView.DOCTOR_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>WishList List</a>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.DOCTOR_CTL%>"><i
							class="fas fa-user-circle"></i>Add Doctor</a> <a
							class="dropdown-item" href="<%=ORSView.DOCTOR_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Doctor List</a>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.DOCTOR_CTL%>"><i
							class="fas fa-user-circle"></i>Add Prescription</a> <a
							class="dropdown-item" href="<%=ORSView.DOCTOR_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Prescription List</a>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PROJECT_CTL%>"><i
							class="fas fa-user-circle"></i>Add Project</a> <a
							class="dropdown-item" href="<%=ORSView.PROJECT_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Project List</a>
