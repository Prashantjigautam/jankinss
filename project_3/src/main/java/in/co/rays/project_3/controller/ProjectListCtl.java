...
@WebServlet(urlPatterns = { "/ctl/ProjectListCtl" })
public class ProjectListCtl extends BaseCtl {

	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(ProjectListCtl.class);
...
// get the selected checkbox ids array for delete list
		...
		try {
			...
			ArrayList<ProjectDTO> a = (ArrayList<ProjectDTO>) list;

			for (ProjectDTO udto1 : a) {
