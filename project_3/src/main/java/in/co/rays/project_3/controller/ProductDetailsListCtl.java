...
@WebServlet(urlPatterns = { "/ctl/ProductDetailsListCtl" })
public class ProductDetailsListCtl extends BaseCtl {

	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(ProductDetailsListCtl.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("ProductDetailsListCtl doGet Start");
		List list;
		List next;
		int pageNo = 1;
...
// TODO Auto-generated catch block
		...
		log.debug("ProductDetailsListCtl doGet End");
