...
@WebServlet(urlPatterns = { "/ctl/ContactListCtl" })
public class ContactListCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("ContactListCtl doGet Start");
		List list;
		List next;
		int pageNo = 1;
...
// get the selected checkbox ids array for delete list
		...
		try {
			...
			ArrayList<ContactDTO> a = (ArrayList<ContactDTO>) list;

			for (ContactDTO udto1 : a) {
...
// get the selected checkbox ids array for delete list
		...
		try {
			...
			dto = (ContactDTO) populateDTO(request);
...
// TODO Auto-generated catch block
		...
		log.debug("ContactListCtl doGet End");
